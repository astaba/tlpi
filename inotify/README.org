...
19.1       Overview
           ...
           2.      The application informs the kernel about which files are of interest by using
                   ...
                   an inotify instance.)
           3.      In order to obtain event notifications, the application performs read() opera-
...
watch descriptor 2                                             watch
                                      path      mask
watch descriptor 3                                             items
                                      path      mask
...
the IN_MASK_ADD flag in the next section.
                                                                           ...
                                                                           M o nit or i ng F il e Ev ents   377
       ...
       taining one or more structures of the following type:
           struct inotify_event {
               ...
               char     name[];       /* Optional null-terminated filename */
                                                                         ...
                                                                         M o nit or i ng F il e Ev ents   379
                                                                                 wd
                                                                                mask
                                                                               cookie
            return value from read() counts this number of bytes                len
                                                                   len bytes   name     terminating null byte
...
read before the IN_MOVED_TO event.
                                                                  ...
                                                                  M o nit or i ng F il e Ev ents   381
...
r               displayInotifyEvent(event);
    ...
    –––––––––––––––––––––––––––––––––––––––––––––––––––– inotify/demo_inotify.c
                                                                    ...
                                                                    M o nit or i ng F il e Ev ents   383
...
19.5   Queue Limits and /proc Files
       ...
       Typical default values for these three files are 16,384, 128, and 8192, respectively.
                                                                       ...
                                                                       M o nit or i ng F il e Ev ents   385
