...
17.1       Overview
           ...
           individual user or group of users (see Figure 17-1).
                            ...
                            Tag type      Tag qualifier Permissions          Corresponds to
                          ACL_USER_OBJ            -          rwx             traditional owner
                          ACL_USER               1007        r--             (user) permissions
                          ACL_USER               1010        rwx             Corresponds to
            Group         ACL_GROUP_OBJ           -          rwx             traditional group
             class                                                           permissions
                          ACL_GROUP              102         r--
           entries
                          ACL_GROUP              103         -w-
                          ACL_GROUP              109         --x
                          ACL_MASK                -          rw-             Corresponds to
                          ACL_OTHER               -          r--             traditional other
                                                                             permissions
...
17.2   ACL Permission-Checking Algorithm
       ...
       1.   If the process is privileged, all access is granted. There is one exception to this
            ...
            the file.
                                                                          ...
                                                                          A c c e ss C o n t r ol L is ts   321
           2.      If the effective user ID of the process matches the owner (user ID) of the file,
           ...
           4.      If one of the process’s group IDs (i.e., the effective group ID or any of the sup-
           ...
           5.      Otherwise, the process is granted the permissions specified in the ACL_OTHER
                   entry.
...
17.3   Long and Short Text Forms for ACLs
       ...
       Table 17-1: Interpretation of ACL entry text forms
        ...
        Tag text   Tag qualifier     Corresponding      Entry for
        forms      present?          tag type
        ...
        o, other          N          ACL_OTHER          Other users
                                                                               ...
                                                                               A c c e ss C o n t r ol L is ts   323
...
17.5   The getfacl and setfacl Commands
       ...
       minimal ACL. When displaying the text form of this ACL, getfacl precedes the ACL
                                                                              ...
                                                                              A c c e ss C o n t r ol L is ts   325
...
17.6   Default ACLs and File Creation
       ...
       We can remove a default ACL from a directory using the setfacl –k option.
                                                                              ...
                                                                              A c c e ss C o n t r ol L is ts   327
...
17.8   The ACL API
       ...
       option, in order to link against the libacl library.
                   ...
                   application to use getxattr() and setxattr() to manipulate ACLs directly.
                                                                              ...
                                                                              A c c e ss C o n t r ol L is ts   329
           Overview
           ...
           structures and indicates the use of many of the ACL functions.
                                          ...
                                          file
                                            ...
                                            ()
                                                    ...
                                                    (in-memory
                                                     ...
                                                     acl_entry_t                                                         acl_entry_t           acl_entry_t
                                                    (ACL entry)                                                         (ACL entry)           (ACL entry)
                                                                                                                                 acl_create_entry(),
                                                       acl_get_qualifier()
                   ...
                   acl_type_t                         void *                                                                  acl_permset_t    acl_get_perm(),
                   (tag type;                     (tag qualifier;                                                             (permission      acl_add_perm(),
                    integer)                        pointer to                                                                     set)        acl_delete_perm(),
                                                  uid_t or gid_t)                                                                              acl_clear_perms()
...
values ACL_USER_OBJ, ACL_USER, ACL_GROUP_OBJ, ACL_GROUP, ACL_OTHER, or ACL_MASK.
                                                                      ...
                                                                      A c c e ss C o n t r ol L is ts   331
...
ACL_GROUP entries to a previously minimal ACL, then we can use this function to
                                                                 ...
                                                                 A c c e ss C o n t r ol L is ts   333
    ...
    for (entryId = ACL_FIRST_ENTRY; ; entryId = ACL_NEXT_ENTRY) {
         ...
         if (acl_get_entry(acl, entryId, &entry) != 1)
             break;                      /* Exit on error or no more entries */
                                                                 ...
                                                                 A c c e ss C o n t r ol L is ts   335
...
17.10 Exercise
 17-1.   Write a program that displays the permissions from the ACL entry that
         ...
         has been modified by the ACL mask entry.
                                                                        ...
                                                                        A c c e ss C o n t r ol L is ts   337
