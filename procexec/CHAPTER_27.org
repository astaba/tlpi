...
#+DESCRIPTION: Chapters 27 from "The Linux Programming Interface" A Linux and UNIX® System Programming by Handbook Michael Kerrisk.
#+STARTUP: showall shrink
#+OPTIONS: ^:{}

* Table of Contents                                                   :toc_2:
- [[#271-executing-a-new-program-execve][27.1 Executing a New Program: execve]]
- [[#272-the-exec-library-functions][27.2 The exec() Library Functions]]
  - [[#2721-the-path-environment-variable][27.2.1 The PATH Environment Variable]]
  - [[#2722-specifying-program-arguments-as-a-list][27.2.2 Specifying Program Arguments as a List]]
  - [[#2723-passing-the-callers-environment-to-the-new-program][27.2.3 Passing the Caller’s Environment to the New Program]]
  - [[#2724-executing-a-file-referred-to-by-a-descriptor-fexecve][27.2.4 Executing a File Referred to by a Descriptor: fexecve]]
- [[#273-interpreter-scripts][27.3 Interpreter Scripts]]
- [[#274-file-descriptors-and-exec][27.4 File Descriptors and exec]]
- [[#275-signals-and-exec][27.5 Signals and exec]]
- [[#276-executing-a-shell-command-system][27.6 Executing a Shell Command: system]]
- [[#277-implementing-system][27.7 Implementing system]]
- [[#278-summary][27.8 Summary]]
- [[#279-exercises][27.9 Exercises]]

* 27.1 Executing a New Program: execve
:PROPERTIES:
:CUSTOM_ID: 271-executing-a-new-program-execve
:END:
* 27.2 The exec() Library Functions
:PROPERTIES:
:CUSTOM_ID: 272-the-exec-library-functions
:END:
** 27.2.1 The PATH Environment Variable
:PROPERTIES:
:CUSTOM_ID: 2721-the-path-environment-variable
:END:
** 27.2.2 Specifying Program Arguments as a List
:PROPERTIES:
:CUSTOM_ID: 2722-specifying-program-arguments-as-a-list
:END:
** 27.2.3 Passing the Caller’s Environment to the New Program
:PROPERTIES:
:CUSTOM_ID: 2723-passing-the-callers-environment-to-the-new-program
:END:
** 27.2.4 Executing a File Referred to by a Descriptor: fexecve
:PROPERTIES:
:CUSTOM_ID: 2724-executing-a-file-referred-to-by-a-descriptor-fexecve
:END:
* 27.3 Interpreter Scripts
:PROPERTIES:
:CUSTOM_ID: 273-interpreter-scripts
:END:
* 27.4 File Descriptors and exec
:PROPERTIES:
:CUSTOM_ID: 274-file-descriptors-and-exec
:END:
* 27.5 Signals and exec
:PROPERTIES:
:CUSTOM_ID: 275-signals-and-exec
:END:
* 27.6 Executing a Shell Command: system
:PROPERTIES:
:CUSTOM_ID: 276-executing-a-shell-command-system
:END:
* 27.7 Implementing system
:PROPERTIES:
:CUSTOM_ID: 277-implementing-system
:END:
* 27.8 Summary
:PROPERTIES:
:CUSTOM_ID: 278-summary
:END:
* 27.9 Exercises
:PROPERTIES:
:CUSTOM_ID: 279-exercises
:END:
...
           z       The execve() and execle() functions allow the programmer to explicitly specify
           ...
           Table 27-1: Summary of differences between the exec() functions
            ...
            Function      Specification     Specification    Source of
                          of program file   of arguments     environment
                          (–, p)            (v, l)           (e, –)
...
588   Chapter 27
27.9     Exercises
 27-1.   The final command in the following shell session uses the program in Listing 27-3
 ...
 27-2.   Use execve() to implement execlp(). You will need to use the stdarg(3) API to handle
