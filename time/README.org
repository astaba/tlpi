...
- [[#105-updating-the-system-clock][10.5 Updating the System Clock]]
...
- [[#108-summary][10.8 Summary]]
- [[#109-exercises][10.9 Exercises]]
...
:PROPERTIES:
:CUSTOM_ID: 102-time-conversion-functions
:END:
...
:PROPERTIES:
:CUSTOM_ID: 1021-converting-time_t-to-printable-form
:END:
...
:PROPERTIES:
:CUSTOM_ID: 1022-converting-between-time_t-and-broken-down-time
:END:
...
:PROPERTIES:
:CUSTOM_ID: 1023-converting-between-broken-down-time-and-printable-form
:END:
...
Selected conversion specifiers for =strftime()= (Refer to
[[man:strftime(3)]] for rich format specifiers):
...
:PROPERTIES:
:CUSTOM_ID: 105-updating-the-system-clock
:END:

* 10.6 The Software Clock (Jiffies)
:PROPERTIES:
:CUSTOM_ID: 106-the-software-clock-jiffies
:END:
...
* 10.8 Summary
:PROPERTIES:
:CUSTOM_ID: 108-summary
:END:

* 10.9 Exercises
:PROPERTIES:
:CUSTOM_ID: 109-exercises
:END:
...
10.2   Time-Conversion Functions
       ...
       locales in Section 10.4.)
                                                                                          ...
                                                                                          Ti me   187
                    fixed-format string                                          user-formatted,
