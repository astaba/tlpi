...
           On most native Linux file systems, filenames can be up to 255 characters long. The
           ...
           number
             ...
             6422   UID=root GID=root
                          type=file
                       perm=rw-r--r--                                  /etc/passwd file
                             ...                                          File data
                     Data block pointers                               (login account
                                                                        information)
...
342   Chapter 18
 i-node        I-node table                        File data
number
                                            /home/erena directory
                                                  ...       ...
                                                 this       61
                                                  ...       ...
  61      UID=erena GID=users                                          Two hard
                  type=file                 /home/allyn directory      links to the
                perm=rw-r--r--                                         same file
                                                 ...        ...
          link count = 2 size=518
             ...
             Data block pointers
                                            ...
                                            /home/kiran directory
                                                  ...       ...
                                                                       A symbolic
 309      UID=kiran GID=users                   other      309
                                                                       link
                type=symlink                      ...       ...
              perm=rwxrwxrwx
          link count = 1 size=16               data for soft link
                     ...                      /home/kiran/other
             Data block pointers               “/home/erena/
                                                    this”
...
372   Chapter 18
18.16 Exercises
 18-1.   In Section 4.3.2, we noted that it is not possible to open a file for writing if it is
 ...
 18-4.   Modify the program in Listing 18-2 (list_files.c) to use readdir_r() instead of readdir().
 18-5.   Implement a function that performs the equivalent of getcwd(). A useful tip for
 ...
 18-6.   Modify the program in Listing 18-3 (nftw_dir_tree.c) to use the FTW_DEPTH flag. Note
         the difference in the order in which the directory tree is traversed.
 18-7.   Write a program that uses nftw() to traverse a directory tree and finishes by
         printing out counts and percentages of the various types (regular, directory,
         symbolic link, and so on) of files in the tree.
 18-8.   Implement nftw(). (This will require the use of the opendir(), readdir(), closedir(), and
         stat() system calls, among others.)
 18-9.   In Section 18.10, we showed two different techniques (using fchdir() and chdir(),
