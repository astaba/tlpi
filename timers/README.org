...
#+DESCRIPTION: Chapter 23 The Linux Programming Interface by Michael Kerrisk
#+STARTUP: showall

* Table Of Contents                                                   :toc_2:
- [[#231-interval-timers][23.1 Interval Timers]]
- [[#232-scheduling-and-accuracy-of-timers][23.2 Scheduling and Accuracy of Timers]]
- [[#233-setting-timeouts-on-blocking-operations][23.3 Setting Timeouts on Blocking Operations]]
- [[#234-suspending-execution-for-a-fixed-interval-sleeping][23.4 Suspending Execution for a Fixed Interval (Sleeping)]]
  - [[#2341-low-resolution-sleeping-sleep][23.4.1 Low-Resolution Sleeping: sleep()]]
  - [[#2342-high-resolution-sleeping-nanosleep][23.4.2 High-Resolution Sleeping: nanosleep()]]
- [[#235-posix-clocks][23.5 POSIX Clocks]]
  - [[#2351-retrieving-the-value-of-a-clock-clock_gettime][23.5.1 Retrieving the Value of a Clock: clock_gettime()]]
  - [[#2352-setting-the-value-of-a-clock-clock_settime][23.5.2 Setting the Value of a Clock: clock_settime()]]
  - [[#2353-obtaining-the-clock-id-of-a-specific-process-or-thread][23.5.3 Obtaining the Clock ID of a Specific Process or Thread]]
  - [[#2354-improved-high-resolution-sleeping-clock_nanosleep][23.5.4 Improved High-Resolution Sleeping: clock_nanosleep()]]
- [[#236-posix-interval-timers][23.6 POSIX Interval Timers]]
  - [[#2361-creating-a-timer-timer_create][23.6.1 Creating a Timer: timer_create()]]
  - [[#2362-arming-and-disarming-a-timer-timer_settime][23.6.2 Arming and Disarming a Timer: timer_settime()]]
  - [[#2363-retrieving-the-current-value-of-a-timer-timer_gettime][23.6.3 Retrieving the Current Value of a Timer: timer_gettime()]]
  - [[#2364-deleting-a-timer-timer_delete][23.6.4 Deleting a Timer: timer_delete()]]
  - [[#2365-notification-via-a-signal][23.6.5 Notification via a Signal]]
  - [[#2366-timer-overruns][23.6.6 Timer Overruns]]
  - [[#2367-notification-via-a-thread][23.6.7 Notification via a Thread]]
- [[#237-timers-that-notify-via-file-descriptors-the-timerfd-api][23.7 Timers That Notify via File Descriptors: the timerfd API]]
- [[#238-summary][23.8 Summary]]
- [[#239-exercises][23.9 Exercises]]

* 23.1 Interval Timers
:PROPERTIES:
:CUSTOM_ID: 231-interval-timers
:END:

* 23.2 Scheduling and Accuracy of Timers
:PROPERTIES:
:CUSTOM_ID: 232-scheduling-and-accuracy-of-timers
:END:

* 23.3 Setting Timeouts on Blocking Operations
:PROPERTIES:
:CUSTOM_ID: 233-setting-timeouts-on-blocking-operations
:END:

* 23.4 Suspending Execution for a Fixed Interval (Sleeping)
:PROPERTIES:
:CUSTOM_ID: 234-suspending-execution-for-a-fixed-interval-sleeping
:END:

** 23.4.1 Low-Resolution Sleeping: sleep()
:PROPERTIES:
:CUSTOM_ID: 2341-low-resolution-sleeping-sleep
:END:

** 23.4.2 High-Resolution Sleeping: nanosleep()
:PROPERTIES:
:CUSTOM_ID: 2342-high-resolution-sleeping-nanosleep
:END:

* 23.5 POSIX Clocks
:PROPERTIES:
:CUSTOM_ID: 235-posix-clocks
:END:

** 23.5.1 Retrieving the Value of a Clock: clock_gettime()
:PROPERTIES:
:CUSTOM_ID: 2351-retrieving-the-value-of-a-clock-clock_gettime
:END:

** 23.5.2 Setting the Value of a Clock: clock_settime()
:PROPERTIES:
:CUSTOM_ID: 2352-setting-the-value-of-a-clock-clock_settime
:END:

** 23.5.3 Obtaining the Clock ID of a Specific Process or Thread
:PROPERTIES:
:CUSTOM_ID: 2353-obtaining-the-clock-id-of-a-specific-process-or-thread
:END:

** 23.5.4 Improved High-Resolution Sleeping: clock_nanosleep()
:PROPERTIES:
:CUSTOM_ID: 2354-improved-high-resolution-sleeping-clock_nanosleep
:END:

* 23.6 POSIX Interval Timers
:PROPERTIES:
:CUSTOM_ID: 236-posix-interval-timers
:END:

** 23.6.1 Creating a Timer: timer_create()
:PROPERTIES:
:CUSTOM_ID: 2361-creating-a-timer-timer_create
:END:

** 23.6.2 Arming and Disarming a Timer: timer_settime()
:PROPERTIES:
:CUSTOM_ID: 2362-arming-and-disarming-a-timer-timer_settime
:END:

** 23.6.3 Retrieving the Current Value of a Timer: timer_gettime()
:PROPERTIES:
:CUSTOM_ID: 2363-retrieving-the-current-value-of-a-timer-timer_gettime
:END:

** 23.6.4 Deleting a Timer: timer_delete()
:PROPERTIES:
:CUSTOM_ID: 2364-deleting-a-timer-timer_delete
:END:

** 23.6.5 Notification via a Signal
:PROPERTIES:
:CUSTOM_ID: 2365-notification-via-a-signal
:END:

** 23.6.6 Timer Overruns
:PROPERTIES:
:CUSTOM_ID: 2366-timer-overruns
:END:

** 23.6.7 Notification via a Thread
:PROPERTIES:
:CUSTOM_ID: 2367-notification-via-a-thread
:END:

* 23.7 Timers That Notify via File Descriptors: the timerfd API
:PROPERTIES:
:CUSTOM_ID: 237-timers-that-notify-via-file-descriptors-the-timerfd-api
:END:

* 23.8 Summary
:PROPERTIES:
:CUSTOM_ID: 238-summary
:END:

* 23.9 Exercises
:PROPERTIES:
:CUSTOM_ID: 239-exercises
:END:
                      TIMERS AND SLEEPING
