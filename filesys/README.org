...
                                   i-node entry
                                                                     ...
                                                                     Key
                     Other file                                      DB = Data block
                   information                                       IPB = Indirect pointer block
                                                                     2IPB = Double IBP
                                                                     3IPB = Triple IPB
                                         0          DB 0             Note: not all blocks are shown
                                         1
                                         2
                                         3
                                         4
...
           To list the currently mounted file systems, we can use the command mount, with no
           ...
           map onto the directory hierarchy.
                      ...
                      sda6 file system
                                                                  ...
                                                                  Mount
               bin             boot            home                            windows
                                                                  points


               bash        vmlinuz       avr          mtk                           C
                                                   ...
                                                   copy.c                           explorer.exe
                   directory
                                               sda9 file system               sda1 file system
               regular file
                                           sda8 file system
