...
#+DESCRIPTION: Chapters 04 from "The Linux Programming Interface" A Linux and UNIX® System Programming by Handbook Michael Kerrisk.
...
- [[#41-overview-1][4.1 Overview]]
- [[#42-universality-of-io-1][4.2 Universality of I/O]]
- [[#43-opening-a-file-open][4.3 Opening a File: open]]
  - [[#431-the-open-flags-argument][4.3.1 The open() flags Argument]]
  - [[#432-errors-from-open][4.3.2 Errors from open]]
  - [[#433-the-creat-system-call][4.3.3 The creat() System Call]]
- [[#44-reading-from-a-file-read-1][4.4 Reading from a File: read]]
- [[#45-writing-to-a-file-write][4.5 Writing to a File: write]]
- [[#46-closing-a-file-close][4.6 Closing a File: close]]
- [[#47-changing-the-file-offset-lseek-1][4.7 Changing the File Offset: lseek]]
- [[#48-operations-outside-the-universal-io-model-ioctl][4.8 Operations Outside the Universal I/O Model: ioctl]]
- [[#49-summary][4.9 Summary]]
- [[#410-exercises-1][4.10 Exercises]]
...
:PROPERTIES:
:CUSTOM_ID: 4-4-reading-from-a-file
:END:
...
* 4.1 Overview
:PROPERTIES:
:CUSTOM_ID: 41-overview
:END:
* 4.2 Universality of I/O
:PROPERTIES:
:CUSTOM_ID: 42-universality-of-io
:END:
* 4.3 Opening a File: open
:PROPERTIES:
:CUSTOM_ID: 43-opening-a-file-open
:END:
** 4.3.1 The open() flags Argument
:PROPERTIES:
:CUSTOM_ID: 431-the-open-flags-argument
:END:
** 4.3.2 Errors from open
:PROPERTIES:
:CUSTOM_ID: 432-errors-from-open
:END:
** 4.3.3 The creat() System Call
:PROPERTIES:
:CUSTOM_ID: 433-the-creat-system-call
:END:
* 4.4 Reading from a File: read
:PROPERTIES:
:CUSTOM_ID: 44-reading-from-a-file-read
:END:
* 4.5 Writing to a File: write
:PROPERTIES:
:CUSTOM_ID: 45-writing-to-a-file-write
:END:
* 4.6 Closing a File: close
:PROPERTIES:
:CUSTOM_ID: 46-closing-a-file-close
:END:
* 4.7 Changing the File Offset: lseek
:PROPERTIES:
:CUSTOM_ID: 47-changing-the-file-offset-lseek
:END:
* 4.8 Operations Outside the Universal I/O Model: ioctl
:PROPERTIES:
:CUSTOM_ID: 48-operations-outside-the-universal-io-model-ioctl
:END:
* 4.9 Summary
:PROPERTIES:
:CUSTOM_ID: 49-summary
:END:
* 4.10 Exercises
:PROPERTIES:
:CUSTOM_ID: 410-exercises
:END:
...
–––––––––––––––––––––––––––––––––––––––––––––––––––––––––––– fileio/copy.c
                                                         ...
                                                         Fi le I/O : The Uni versal I/O Model   71
4.2          Universality of I/O
...
ensures that a file is opened using standard input (file descriptor 0).
                                                              ...
                                                              Fi le I/O : The Uni versal I/O Model   73
...
O_CLOEXEC (since Linux 2.6.23)
           ...
           the file descriptor and uses fcntl() to set the close-on-exec flag.) Such races
                                                                ...
                                                                Fi le I/O : The Uni versal I/O Model   75
...
4.4   Reading from a File: read()
      ...
      include characters in addition to the string actually entered. This is because read()
                                                                ...
                                                                Fi le I/O : The Uni versal I/O Model   79
...
            The offset argument specifies a value in bytes. (The off_t data type is a signed integer
            ...
            Figure 4-1 shows how the whence argument is interpreted.
                           ...
                           different names for these values: L_SET, L_INCR, and L_XTND.
                                      ...
                                      File containing                     Unwritten bytes
                                      N bytes of data                       past EOF
             byte
                           0      1   ...              ...     N–2 N–1 N N+1         ...
            number
                                                        Current
...
Such a scenario is uncommon, but nevertheless one to be aware of.
             ...
             tem call when it is available.
                                                              ...
                                                              Fi le I/O : The Uni versal I/O Model   83
...
showing what happens when we attempt to read bytes from a file hole:
    ...
    wabc: wrote 3 bytes
                                                          ...
                                                          Fi le I/O : The Uni versal I/O Model   85
...
4.10    Exercises
 ...
 4-2.   Write a program like cp that, when used to copy a regular file that contains holes
        (sequences of null bytes), also creates corresponding holes in the target file.
                                                                ...
                                                                Fi le I/O : The Uni versal I/O Model   87
