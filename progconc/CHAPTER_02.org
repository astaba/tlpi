...
#+DESCRIPTION: Chapters 02 from "The Linux Programming Interface" A Linux and UNIX® System Programming by Handbook Michael Kerrisk.
#+STARTUP: showall

* Table Of Contents                                                   :toc_2:
- [[#21-the-core-operating-system-the-kernel][2.1 The Core Operating System: The Kernel]]
- [[#22-the-shell][2.2 The Shell]]
- [[#23-users-and-groups][2.3 Users and Groups]]
- [[#24-single-directory-hierarchy-directories-links-and-files][2.4 Single Directory Hierarchy, Directories, Links, and Files]]
- [[#25-file-io-model][2.5 File I/O Model]]
- [[#26-programs][2.6 Programs]]
- [[#27-processes][2.7 Processes]]
- [[#28-memory-mappings][2.8 Memory Mappings]]
- [[#29-static-and-shared-libraries][2.9 Static and Shared Libraries]]
- [[#210-interprocess-communication-and-synchronization][2.10 Interprocess Communication and Synchronization]]
- [[#211-signals][2.11 Signals]]
- [[#212-threads][2.12 Threads]]
- [[#213-process-groups-and-shell-job-control][2.13 Process Groups and Shell Job Control]]
- [[#214-sessions-controlling-terminals-and-controlling-processes][2.14 Sessions, Controlling Terminals, and Controlling Processes]]
- [[#215-pseudoterminals][2.15 Pseudoterminals]]
- [[#216-date-and-time][2.16 Date and Time]]
- [[#217-client-server-architecture][2.17 Client-Server Architecture]]
- [[#218-realtime][2.18 Realtime]]
- [[#219-the-proc-file-system][2.19 The /proc File System]]
- [[#220-summary][2.20 Summary]]

* 2.1 The Core Operating System: The Kernel
:PROPERTIES:
:CUSTOM_ID: 21-the-core-operating-system-the-kernel
:END:

* 2.2 The Shell
:PROPERTIES:
:CUSTOM_ID: 22-the-shell
:END:

* 2.3 Users and Groups
:PROPERTIES:
:CUSTOM_ID: 23-users-and-groups
:END:

* 2.4 Single Directory Hierarchy, Directories, Links, and Files
:PROPERTIES:
:CUSTOM_ID: 24-single-directory-hierarchy-directories-links-and-files
:END:

* 2.5 File I/O Model
:PROPERTIES:
:CUSTOM_ID: 25-file-io-model
:END:

* 2.6 Programs
:PROPERTIES:
:CUSTOM_ID: 26-programs
:END:

* 2.7 Processes
:PROPERTIES:
:CUSTOM_ID: 27-processes
:END:

* 2.8 Memory Mappings
:PROPERTIES:
:CUSTOM_ID: 28-memory-mappings
:END:

* 2.9 Static and Shared Libraries
:PROPERTIES:
:CUSTOM_ID: 29-static-and-shared-libraries
:END:

* 2.10 Interprocess Communication and Synchronization
:PROPERTIES:
:CUSTOM_ID: 210-interprocess-communication-and-synchronization
:END:

* 2.11 Signals
:PROPERTIES:
:CUSTOM_ID: 211-signals
:END:

* 2.12 Threads
:PROPERTIES:
:CUSTOM_ID: 212-threads
:END:

* 2.13 Process Groups and Shell Job Control
:PROPERTIES:
:CUSTOM_ID: 213-process-groups-and-shell-job-control
:END:

* 2.14 Sessions, Controlling Terminals, and Controlling Processes
:PROPERTIES:
:CUSTOM_ID: 214-sessions-controlling-terminals-and-controlling-processes
:END:

* 2.15 Pseudoterminals
:PROPERTIES:
:CUSTOM_ID: 215-pseudoterminals
:END:

* 2.16 Date and Time
:PROPERTIES:
:CUSTOM_ID: 216-date-and-time
:END:

* 2.17 Client-Server Architecture
:PROPERTIES:
:CUSTOM_ID: 217-client-server-architecture
:END:

* 2.18 Realtime
:PROPERTIES:
:CUSTOM_ID: 218-realtime
:END:

* 2.19 The /proc File System
:PROPERTIES:
:CUSTOM_ID: 219-the-proc-file-system
:END:

* 2.20 Summary
:PROPERTIES:
:CUSTOM_ID: 220-summary
:END:
...
any time for a process. Many things happen transparently for a process. A process
                                                                  ...
                                                                  F un d a m e n t a l C on c e p t s   23
...
z   Bourne shell (sh): This is the oldest of the widely used shells, and was written by
...
z   C shell (csh): This shell was written by Bill Joy at the University of California at
...
z   Korn shell (ksh): This shell was written as the successor to the Bourne shell by
...
z   Bourne again shell (bash): This shell is the GNU project’s reimplementation of
...
reader can assume these examples work the same way in other Bourne-type shells.
                                                                    ...
                                                                    F un d a m e n t a l C on c e p t s   25
2.3          Users and Groups
             ...
             z    Group ID: the numeric group ID of the first of the groups of which the user is a
                  member.
             z    Home directory: the initial directory into which the user is placed after logging in.
             z    Login shell: the name of the program to be executed to interpret user commands.
             ...
             z    Group name: the (unique) name of the group.
             z    Group ID (GID): the numeric ID associated with this group.
             z    User list: a comma-separated list of login names of users who are members of
...
2.4   Single Directory Hierarchy, Directories, Links, and Files
      ...
      this hierarchical file structure.
       ...
       bash        vmlinuz     group         passwd     avr          mtk               include
      ...
      equates to /).
                                                                              ...
                                                                              F un d a m e n t a l C on c e p t s   27
            Symbolic links
...
2.5   File I/O Model
      ...
      cept of universality of I/O. This means that the same system calls (open(), read(),
                                                                        ...
                                                                        F un d a m e n t a l C on c e p t s   29
...
2.7   Processes
      ...
      the child process. The kernel creates the child process by making a duplicate of the
                                                                        ...
                                                                        F un d a m e n t a l C on c e p t s   31
...
32   Chapter 2
z   Effective user ID and effective group ID: These two IDs (in conjunction with the
...
processes required by a running system. (For details, see the init(8) manual page.)
                                                                  ...
                                                                  F un d a m e n t a l C on c e p t s   33
            Daemon processes
...
2.9   Static and Shared Libraries
      ...
      static libraries and shared libraries.
                                                                         ...
                                                                         F un d a m e n t a l C on c e p t s   35
            Static libraries
...
2.11   Signals
       ...
       kill() system call provides the same facility within programs.
                                                                       ...
                                                                       F un d a m e n t a l C on c e p t s   37
...
2.15   Pseudoterminals
       ...
       ter device to drive the terminal-oriented program. Output written by the driver
                                                                          ...
                                                                          F un d a m e n t a l C on c e p t s   39
...
2.18   Realtime
       ...
       policies, realtime signals, message queues, and semaphores. Even though they
                                                                        ...
                                                                        F un d a m e n t a l C on c e p t s   41
