...
#+DESCRIPTION: Chapters 01 from "The Linux Programming Interface" A Linux and UNIX® System Programming by Handbook Michael Kerrisk.
#+STARTUP: showall shrink
#+OPTIONS: ^:{}

* Table of Contents                                                   :toc_2:
- [[#11-a-brief-history-of-unix-and-c][1.1 A Brief History of UNIX and C]]
- [[#12-a-brief-history-of-linux][1.2 A Brief History of Linux]]
  - [[#121-the-gnu-project][1.2.1 The GNU Project]]
  - [[#122-the-linux-kernel][1.2.2 The Linux Kernel]]
- [[#13-standardization][1.3 Standardization]]
  - [[#131-the-c-programming-language][1.3.1 The C Programming Language]]
  - [[#132-the-first-posix-standards][1.3.2 The First POSIX Standards]]
  - [[#133-xopen-company-and-the-open-group][1.3.3 X/Open Company and The Open Group]]
  - [[#134-susv3-and-posix1-2001][1.3.4 SUSv3 and POSIX.1-2001]]
  - [[#135-susv4-and-posix1-2008][1.3.5 SUSv4 and POSIX.1-2008]]
  - [[#136-unix-standards-timeline][1.3.6 UNIX Standards Timeline]]
  - [[#137-implementation-standards][1.3.7 Implementation Standards]]
  - [[#138-linux-standards-and-the-linux-standard-base][1.3.8 Linux, Standards, and the Linux Standard Base]]
- [[#14-summary][1.4 Summary]]

* 1.1 A Brief History of UNIX and C
:PROPERTIES:
:CUSTOM_ID: 11-a-brief-history-of-unix-and-c
:END:
* 1.2 A Brief History of Linux
:PROPERTIES:
:CUSTOM_ID: 12-a-brief-history-of-linux
:END:
** 1.2.1 The GNU Project
:PROPERTIES:
:CUSTOM_ID: 121-the-gnu-project
:END:
** 1.2.2 The Linux Kernel
:PROPERTIES:
:CUSTOM_ID: 122-the-linux-kernel
:END:
* 1.3 Standardization
:PROPERTIES:
:CUSTOM_ID: 13-standardization
:END:
** 1.3.1 The C Programming Language
:PROPERTIES:
:CUSTOM_ID: 131-the-c-programming-language
:END:
** 1.3.2 The First POSIX Standards
:PROPERTIES:
:CUSTOM_ID: 132-the-first-posix-standards
:END:
** 1.3.3 X/Open Company and The Open Group
:PROPERTIES:
:CUSTOM_ID: 133-xopen-company-and-the-open-group
:END:
** 1.3.4 SUSv3 and POSIX.1-2001
:PROPERTIES:
:CUSTOM_ID: 134-susv3-and-posix1-2001
:END:
** 1.3.5 SUSv4 and POSIX.1-2008
:PROPERTIES:
:CUSTOM_ID: 135-susv4-and-posix1-2008
:END:
** 1.3.6 UNIX Standards Timeline
:PROPERTIES:
:CUSTOM_ID: 136-unix-standards-timeline
:END:
** 1.3.7 Implementation Standards
:PROPERTIES:
:CUSTOM_ID: 137-implementation-standards
:END:
** 1.3.8 Linux, Standards, and the Linux Standard Base
:PROPERTIES:
:CUSTOM_ID: 138-linux-standards-and-the-linux-standard-base
:END:
* 1.4 Summary
:PROPERTIES:
:CUSTOM_ID: 14-summary
:END:
...
tained a number of new tools, including awk, make, sed, tar, uucp, the Bourne shell,
                                                                     ...
                                                                     Hi s t o r y a n d S t a n d a rd s   3
...
1.2.1   The GNU Project
        ...
        General Public License (GPL), the legal embodiment of Stallman’s notion of free
                                                                          ...
                                                                          Hi s t o r y a n d S t a n d a rd s   5
...
from the NetBSD project. OpenBSD emphasizes security. In mid-2003, a new BSD,
                                                                         Hi s t o r y a n d S t a n d a rd s   7
...
tures. However, with the increasing popularity of Linux, ports to other processor
                                                                       ...
                                                                       Hi s t o r y a n d S t a n d a rd s   9
...
1.3.2   The First POSIX Standards
        ...
        are not available online, but can be purchased from the IEEE at http://www.ieee.org/.)
                                                                            ...
                                                                            His t o ry a n d S t a n d a r d s   11
...
1.3.4   SUSv3 and POSIX.1-2001
        ...
        Version 3, and we’ll generally refer to it in the remainder of this book as SUSv3.
                                                                          ...
                                                                          His t o ry a n d S t a n d a r d s   13
...
1.3.5   SUSv4 and POSIX.1-2008
        ...
        z   SUSv4 adds new specifications for a range of functions. Among the newly spec-
            ...
            rather than relative to the process’s current working directory.
                                                                            ...
                                                                            His t o ry a n d S t a n d a r d s   15
           ...
           (1990, ISO)
                     ...
                     Realtime
                            ...
                            POSIX.1c                          Sockets             (1994)
                              (1995)                                           [SUS , UNIX
                             Threads                             XNS          95, Spec 1170]
                                                              (4, 5, 5.2)
            POSIX.1
           (1996, ISO)                                                              SUSv2
                                                                                    (1997)
                                                                                  [UNIX 98,
            POSIX.1d                   ISO C 99                                     XPG5]
             (1999)                     (1999)
         Additional real-
         time extensions
            ...
            POSIX.1j
             (2000)
          Advanced real-               POSIX.1-2001 / SUSv3
         time extensions                (2001, Austin CSRG)
                                             [UNIX 03]
...
1.3.7   Implementation Standards
        ...
        face Definition (SVID). In 1989, AT&T published Issue 3 of the SVID, which
                                                                            ...
                                                                            His t o ry a n d S t a n d a r d s   17
...
1.4   Summary
      ...
      kernel for the Intel x86-32 architecture. Torvalds invited other programmers to
                                                                          ...
                                                                          His t o ry a n d S t a n d a r d s   19
