...
- [[#33-the-standard-c-library-and-the-gnu-c-library-glibc][3.3 The Standard C Library and The GNU C Library (glibc)]]
...
:END:
* 3.3 The Standard C Library and The GNU C Library (glibc)
:PROPERTIES:
:CUSTOM_ID: 33-the-standard-c-library-and-the-gnu-c-library-glibc
:END:
...
to mean “calling the wrapper function that invokes the system call xyz().”
                                                                 ...
                                                                 S y s t e m P r o gr a m m i n g C on c e p t s   45
                                        User Mode
                  ...
                  service routine             (arch/x86/kernel/entry_32.S)
                  (arch/x86/kernel/
                    process_32.c)             system_call:
      ...
      resulting library dependency list to find the location of the glibc shared library:
          $ ldd myprog | grep libc
                  libc.so.6 => /lib/tls/libc.so.6 (0x4004b000)
                                                                        ...
                                                                        S y s t e m P r o gr a m m i n g C on c e p t s   47
...
given in its errnum argument.
                                                           ...
                                                           S y s t e m P r o gr a m m i n g C on c e p t s   49
                 #include <string.h>
...
3.5.2   Common Functions and Header Files
        ...
        functions whose declarations are shown in Listing 3-2.
                                                                       ...
                                                                       S y s t e m P r o gr a m m i n g C on c e p t s   51
...
To diagnose other types of errors, we use fatal(), usageErr(), and cmdLineErr().
                                                              ...
                                                              S y s t e m P r o gr a m m i n g C on c e p t s   53
                #include "tlpi_hdr.h"
...
errExit(const char *format, ...)
{
    ...
    terminate(TRUE);
                                                            ...
                                                            S y s t e m P r o gr a m m i n g C on c e p t s   55
            void
...
error names have the same numeric value.
             ...
             blocking calls, only the error EAGAIN is specified in SUSv3.
                                                                 ...
                                                                 S y s t e m P r o gr a m m i n g C on c e p t s   57
...
#include "get_num.h"
                                                                 ...
                                                                 S y s t e m P r o gr a m m i n g C on c e p t s   59
            static void
...
3.6.1   Feature Test Macros
        ...
        _POSIX_C_SOURCE
                ...
                fication (i.e., the XSI extension is excluded). (Prior to version 2.3.3, the
                                                                       ...
                                                                       S y s t e m P r o gr a m m i n g C on c e p t s   61
...
3.6.2   System Data Types
        ...
        types, and requires an implementation to define and use these types appropriately.
                                                                     ...
                                                                     S y s t e m P r o gr a m m i n g C on c e p t s   63
...
Table 3-1: Selected system data types (continued)
 ...
 socklen_t      integer type of at least     Size of a socket address structure in bytes
                32 bits                      (Section 56.3)
 ...
 stack_t        structure type               Description of an alternate signal stack
                                             (Section 21.3)
 suseconds_t    signed integer allowing      Microsecond time interval (Section 10.1)
                range [–1, 1000000]
...
doesn’t care which data type is used.)
                                                                ...
                                                                S y s t e m P r o gr a m m i n g C on c e p t s   65
...
the accompanying comment /* For portability */. This indicates that the header file
                                                              ...
                                                              S y s t e m P r o gr a m m i n g C on c e p t s   67
