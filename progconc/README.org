...
#+DESCRIPTION: Chapters 03 from "The Linux Programming Interface" A Linux and UNIX® System Programming by Handbook Michael Kerrisk.
#+STARTUP: showall shrink
#+OPTIONS: ^:{}

* Table Of Contents                                                   :toc_2:
- [[#31-system-calls][3.1 System Calls]]
- [[#32-library-functions][3.2 Library Functions]]
- [[#33-the-standard-c-library-the-gnu-c-library-glibc][3.3 The Standard C Library; The GNU C Library (glibc)]]
- [[#34-handling-errors-from-system-calls-and-library-functions][3.4 Handling Errors from System Calls and Library Functions]]
- [[#35-notes-on-the-example-programs-in-this-book][3.5 Notes on the Example Programs in This Book]]
  - [[#351-command-line-options-and-arguments][3.5.1 Command-Line Options and Arguments]]
  - [[#352-common-functions-and-header-files][3.5.2 Common Functions and Header Files]]
- [[#36-portability-issues][3.6 Portability Issues]]
  - [[#361-feature-test-macros][3.6.1 Feature Test Macros]]
  - [[#362-system-data-types][3.6.2 System Data Types]]
  - [[#363-miscellaneous-portability-issues][3.6.3 Miscellaneous Portability Issues]]
- [[#37-summary][3.7 Summary]]
...
* 3.1 System Calls
:PROPERTIES:
:CUSTOM_ID: 31-system-calls
:END:

* 3.2 Library Functions
:PROPERTIES:
:CUSTOM_ID: 32-library-functions
:END:

* 3.3 The Standard C Library; The GNU C Library (glibc)
:PROPERTIES:
:CUSTOM_ID: 33-the-standard-c-library;-the-gnu-c-library-glibc
:END:

* 3.4 Handling Errors from System Calls and Library Functions
:PROPERTIES:
:CUSTOM_ID: 34-handling-errors-from-system-calls-and-library-functions
:END:

* 3.5 Notes on the Example Programs in This Book
:PROPERTIES:
:CUSTOM_ID: 35-notes-on-the-example-programs-in-this-book
:END:

** 3.5.1 Command-Line Options and Arguments
:PROPERTIES:
:CUSTOM_ID: 351-command-line-options-and-arguments
:END:

** 3.5.2 Common Functions and Header Files
:PROPERTIES:
:CUSTOM_ID: 352-common-functions-and-header-files
:END:

*** Error-diagnostic functions
- Reference: [[file:~/coding/c_prog/tlpi/lib/error_functions.c][error_functions.c]].
...
to a specific memory location. *A variable* =x= is an =lvalue= because
you can find where it lives in RAM. *The number =5= is not* an
=lvalue=; it's just a value. You can't say "the address of 5."

A *modifiable* =lvalue= is a memory location that you are allowed to
change: in =int x = 10;= the =x= is a modifiable =lvalue=. You can do
=x = 20;=. However in =const int y = 10;= the =y= is an =lvalue= (it
has an address), but it is *not modifiable*.

**** =errno= and Threads

***** 3. The Problem with =errno= and Threads
...
:PROPERTIES:
:CUSTOM_ID: 36-portability-issues
:END:

** 3.6.1 Feature Test Macros
:PROPERTIES:
:CUSTOM_ID: 361-feature-test-macros
:END:
...
:PROPERTIES:
:CUSTOM_ID: 362-system-data-types
:END:
...
:PROPERTIES:
:CUSTOM_ID: 363-miscellaneous-portability-issues
:END:

* 3.7 Summary
:PROPERTIES:
:CUSTOM_ID: 37-summary
:END:
