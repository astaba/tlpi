...
- [[#errno-and-threads-352][=errno= and Threads (3.5.2)]]
  - [[#1-what-is-an-lvalue][1. What is an =lvalue=?]]
  - [[#2-what-is-a-modifiable-lvalue][2. What is a "Modifiable lvalue"?]]
  - [[#3-the-the-problem-with-errno-and-threads][3. The "The Problem" with =errno= and Threads]]
  - [[#4-the-macro-solution][4. The "Macro" Solution]]
  - [[#5-the-leftover-error-the-logic-bug][5. The "Leftover" Error (The logic bug)]]
  - [[#6-the-hidden-function-overhead-the-efficiency-bug][6. The "Hidden Function" Overhead (The efficiency bug)]]
  - [[#the-correct-pthread-pattern][The "Correct" Pthread Pattern]]
  - [[#summary-of-the-modifiable-lvalue][Summary of the "Modifiable Lvalue"]]
- [[#the-inc-extension-352][The =.inc= extension (3.5.2)]]
  - [[#why-use-cinc-instead-of-just-h][Why use =.c.inc= instead of just =.h=?]]
  - [[#how-its-used-in-the-linux-programming-interface][How it's used in "The Linux Programming Interface"]]
  - [[#why-is-this-done][Why is this done?]]
  - [[#summary][Summary]]
- [[#capabilities][Capabilities]]
  - [[#the-fix][The Fix]]
  - [[#why-tlpi-needs-this][Why TLPI needs this]]
  - [[#a-critical-makefile-hint][A Critical "Makefile" Hint]]
- [[#compiler-extenson-__attribute__][Compiler extenson: =__attribute__=]]
  - [[#1-the-noreturn-logic][1. The =NORETURN= Logic]]
  - [[#2-syntax--placement][2. Syntax & Placement]]
  - [[#3-the-identifier-namespace-the-__-rule][3. The Identifier Namespace (The =__= Rule)]]
  - [[#4-crucial-distinction-compiler-vsfeature-test-macros][4. Crucial Distinction: Compiler vs. Feature Test Macros]]
  - [[#final-takeaway][Final Takeaway]]
- [[#printing-system-data-type-values-362][Printing system data type values (3.6.2)]]
...
- *A variable* =x= is an =lvalue= because you can find where it lives in
  RAM.
...
- =const int y = 10;= --- =y= is an =lvalue= (it has an address), but it
  is *not modifiable*.
...
// We use Kerrisk's nmsetErr(nmsetErr(
if (s != 0)
    nmsetErr(nmsetErr(
#+end_src
