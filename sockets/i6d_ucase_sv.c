/* =========================================================================
 * Created on: <Sat Apr 11 19:19:29 +01 2026>
 * Time-stamp: <Mon Apr 13 04:06:25 +01 2026 by owner>
 * Author    : Copyright (C) Michael Kerrisk, 2026
 *             See file [[file:../COPYING.gpl-v3]] for details GNU License.
 * Desc      : ~/coding/c_prog/tlpi/sockets/i6d_ucase_sv.c -
 *
 * Listing 59.3 A server that receives datagrams, converts their
 * contents to uppercase, and then returns them to the senders. See
 * also [[file:i6d_ucase_cl.c]].
 * ========================================================================= */
#include "i6d_ucase.h"
