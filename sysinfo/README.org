...
thread in this process, the kernel provides a subdirectory named /proc/PID/task/TID,
                                                              ...
                                                              S y stem and Process Information   225
...
time we try to open a file in that directory.
                                                                   ...
                                                                   S y stem and Process Information   227
           Example program
...
12.2   System Identification: uname()
       ...
       as the host’s DNS domain name).
                                                                    ...
                                                                    S y stem and Process Information   229
...
12.4     Exercises
 ...
 12-2.   Write a program that draws a tree showing the hierarchical parent-child
 ...
 12-3.   Write a program that lists all processes that have a particular file pathname open.
         ...
         of readlink(), described in Section 18.5.
                                                                   ...
                                                                   S y stem and Process Information   231
